 ...
 *       &lt;sequence>
 *         &lt;element name="config" type="{http://palava.cosmocode.de/palava-mail/2.0}configType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "attachmentType", namespace = "http://palava.cosmocode.de/palava-mail/2.0", propOrder = {
    "config"
})
